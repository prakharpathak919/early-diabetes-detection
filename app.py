...
# ============ SIDEBAR NAV =============
st.sidebar.image("https://github.com/prakharpathak919/early-diabetes-detection/blob/main/logo.png", width=100, caption="Early Diabetes Predictor", use_container_width=True)
